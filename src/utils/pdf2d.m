...
%
%[x0,y0]=pdf2d(Xin,Yin,dist_in,varargin);
%
...
% vals=zeros(2,N);
% for i=1:N
%    [vals(1,i),vals(2,i)]=pdf2d(Xin,Yin,Dist);
% end
%
% figure;
% hold on
...
% vals=zeros(2,N);
% for i=1:N
%    [vals(1,i),vals(2,i)]=pdf2d(Xin,Yin,Dist,res);
% end
%
% figure;
% hold on
...
function [x0,y0]=pdf2d(Xin,Yin,dist_in,varargin)
%check input
